...
export const generateMicrosoftLink = (id: string) => `[${id}](https://marketplace.visualstudio.com/items?itemName=${id})`;

export const generateOpenVsxLink = (id: string) => `[${id}](https://${registryHost}/extension/${id.split(".")[0]}/${id.split(".")[1]})`;
